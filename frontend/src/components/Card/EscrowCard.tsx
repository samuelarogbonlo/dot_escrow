import { Box, Text, Heading, Flex, Badge, Grid, useColorModeValue } from '@chakra-ui/react'
    ...
    >
      ...
      {nextMilestone && (
        <Box mt={2} p={2} bg={useColorModeValue('gray.50', 'gray.700')} borderRadius="md">
          ...
          <Text fontSize="sm" fontWeight="medium">{formatDate(nextMilestone.deadline)}</Text>
        </Box>
      )}
    </Box>
  )
